...
def get_train_dicts():
    ...
    with open("/content/open-images/int_category_labels.json") as fp:
        category_labels = json.load(fp)
    #with open("/floyd/input/open-images/train_XYXY.json") as f:
    with open("/content/open-images/train_XYXY.json") as f:
    ...
    for img in img_anns['images']:
        ...
        record["file_name"] = "/content/open-images/train_resized/" + img["file_name"]
